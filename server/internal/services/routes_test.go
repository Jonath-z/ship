...
func TestRoutesDeclareServicePermissions(t *testing.T) {
	...
	want := map[string]access.Permission{
		...
		"GET " + base + "/:serviceId":    access.ConfigurationRead,
		"PATCH " + base + "/:serviceId":  access.ConfigurationManage,
		"DELETE " + base + "/:serviceId": access.ConfigurationManage,
	}
