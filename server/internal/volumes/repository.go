...
func (repository *Repository) List(ctx context.Context, environmentID, cursor string, limit int) ([]migrations.Volume, string, error) {
...
func (repository *Repository) Find(ctx context.Context, environmentID, volumeID string) (migrations.Volume, error) {
	var row migrations.Volume
	if err := repository.db.WithContext(ctx).
		First(&row, "id = ? AND environment_id = ?", volumeID, environmentID).Error; err != nil {
		return migrations.Volume{}, err
	}
	return row, nil
}

func (repository *Repository) Create(ctx context.Context, row *migrations.Volume) error {
	return repository.db.WithContext(ctx).Create(row).Error
}

func (repository *Repository) Update(ctx context.Context, row *migrations.Volume, values map[string]any) error {
...
func (repository *Repository) Delete(ctx context.Context, row *migrations.Volume) error {
